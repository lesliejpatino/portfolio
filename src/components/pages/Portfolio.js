...
export default function Portfolio() {
    ...
    return (
        <>
            ...
            <div className="col-12 my-5 projects mb-5 justify-content-center">
                {/* <div className="row mb-5 justify-content-center"> */}
                {/* Card 1 */}
                <div className="card col-lg-3 col-md-5 col-sm-8 mx-4 mb-5 p-0" data-aos="fade-right" data-aos-easing="linear" data-aos-duration="500">
                    <a
